class CSaveData
{
   var _Player1_KeyMoveDown;
   var _Player1_KeyMoveLeft;
   var _Player1_KeyMoveRight;
   var _Player1_KeyMoveUp;
   var _Player1_KeyNextWeapon;
   var _Player1_KeyPrevWeapon;
   var _Player1_KeyShoot;
   var _Player2_KeyMoveDown;
   var _Player2_KeyMoveLeft;
   var _Player2_KeyMoveRight;
   var _Player2_KeyMoveUp;
   var _Player2_KeyNextWeapon;
   var _Player2_KeyPrevWeapon;
   var _Player2_KeyShoot;
   var _Username;
   static var _this;
   static var mSharedObject;
   static var obj;
   ...
   {
      CSaveData._this.mDetail = CSaveData._this._Detail;
   }
   ...
   function LoadData(tUsername)
   {
      ...
      this.mMusicActive = CSaveData.mSharedObject.data.mMusicActive != undefined ? CSaveData.mSharedObject.data.mMusicActive : true;
      this.mSoundActive = CSaveData.mSharedObject.data.mSoundActive != undefined ? CSaveData.mSharedObject.data.mSoundActive : true;
      this.mDetail = CSaveData.mSharedObject.data.mDetail != undefined ? CSaveData.mSharedObject.data.mDetail : true;
      return "success";
   }
   function ResetData()
   {
