...
{
   var _Logo_CrazyMonkeys;
   var _Logo_SeanCooper;
   var _parent;
   var mNormal;
   var mSequence;
   var mSequenceIndex;
   ...
   function Process()
   {
      ...
      if(this.mNormal)
      {
         _loc3_ = this.mSequence[this.mSequenceIndex];
         ...
         {
            _loc4_ = this.GetFrameIndex(_loc3_._totalframes,_loc3_.mFrameRate);
   ...
   function GetFrameIndex(tTotalFrames, tFrameRate)
   {
      ...
      var _loc2_ = int((getTimer() - this.mTimeSlice) / (1000 / tFrameRate)) + 1;
