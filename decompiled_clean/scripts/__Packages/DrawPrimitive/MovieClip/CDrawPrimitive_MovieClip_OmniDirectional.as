class DrawPrimitive.MovieClip.CDrawPrimitive_MovieClip_OmniDirectional extends DrawPrimitive.MovieClip.CDrawPrimitive_MovieClip
{
   ...
   {
      var _loc3_ = this.bmList[Thing.Math.CThing_Angle.mLookup256[this.bmList.length][tAngle.mAngle * DrawPrimitive.CDrawPrimitive.mRadsTo256 & 0xFF]];
   ...
   function Buffer(mc, tDirections)
   {
      ...
      {
         this.bmList.push(this._Buffer(mc,_loc2_));
