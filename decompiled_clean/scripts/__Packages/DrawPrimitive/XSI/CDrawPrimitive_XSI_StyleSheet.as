class DrawPrimitive.XSI.CDrawPrimitive_XSI_StyleSheet
{
   static var mXSI_DI;
   var _CLASSID_ = "CDrawPrimitive_XSI_StyleSheet";
   var _BASECLASSID_ = "CDrawPrimitive_XSI_StyleSheet";
   static var mDefault_AnimID = "Player_Handgun_Walk";
   function CDrawPrimitive_XSI_StyleSheet()
   {
   }
   static function SS_FINALIZE(tStyleSheet)
   {
   ...
   static function SS_APPLY(tStyleSheet)
   {
   ...
   static function SS_DEVIL(tScale)
   {
      var _loc1_ = DrawPrimitive.XSI.CDrawPrimitive_XSI_StyleSheet.mXSI_DI.GetStyleSheet(DrawPrimitive.XSI.CDrawPrimitive_XSI_StyleSheet.mDefault_AnimID);
      _loc1_.mID = "SS_DEVIL";
      _loc1_.mModels.Weapon_Right.mVisible = false;
