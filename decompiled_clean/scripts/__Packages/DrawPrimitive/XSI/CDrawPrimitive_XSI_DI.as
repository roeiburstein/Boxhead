class DrawPrimitive.XSI.CDrawPrimitive_XSI_DI extends DrawPrimitive.XSI.CDrawPrimitive_XSI
{
   ...
   var mcPlanes;
   var mcShadow;
   static var mRenderCount_Frames;
   static var mRenderStack;
   ...
   function GetStyleSheet(tAnimationSetID)
   {
      ...
      if(_loc10_ = DrawPrimitive.XSI.CDrawPrimitive_XSI_DI.mAnimationSets[tAnimationSetID])
      {
         ...
         _loc6_ = _loc10_.mDirections[0][0].Models;
   ...
   static function LoadAnimation(oXSI_Animation, linkID, tRetrieveID)
   {
      ...
      _loc6_.XSI_Info.PFactor = - Math.sin(_loc4_.mTilt);
      ...
      var _loc1_;
      var _loc2_;
      while(_loc5_ < _loc6_.mDirections.length)
      {
         _loc3_ = _loc4_.mDirections[_loc5_];
         _loc11_ = _loc6_.mDirections[_loc5_] = {mFrames:new Array(_loc3_.length)};
         _loc7_ = !_loc4_.mFrameSequence ? _loc3_.length : _loc4_.mFrameSequence.length;
         _loc6_.mFrameCount = _loc7_;
         _loc1_ = 0;
         while(_loc1_ < _loc7_)
         {
            if(_loc4_.mFrameSequence && _loc4_.mFrameSequence[_loc1_] != _loc1_)
            {
               _loc2_ = _loc6_.mDirections[_loc5_].mFrames[_loc4_.mFrameSequence[_loc1_]];
            }
            if(!_loc2_)
            {
               _loc2_ = DrawPrimitive.XSI.CDrawPrimitive_XSI_DI.AddToRenderStack(_loc8_,_loc3_[_loc1_],oXSI_Animation);
               _loc2_.XSI_Info = new Object();
               DrawPrimitive.XSI.CDrawPrimitive_XSI_DI.FillXSIInfo(_loc3_[_loc1_].Models,_loc2_,"Hand_Right");
               DrawPrimitive.XSI.CDrawPrimitive_XSI_DI.FillXSIInfo(_loc3_[_loc1_].Models,_loc2_,"Hand_Left");
               DrawPrimitive.XSI.CDrawPrimitive_XSI_DI.FillXSIInfo(_loc3_[_loc1_].Models,_loc2_,"GunPosition_Right");
            }
            _loc6_.mDirections[_loc5_].mFrames[_loc1_] = _loc2_;
   ...
   static function FillXSIInfo(tModels, oFrame, mprop)
   {
      ...
      _loc1_.nPosition = new Thing.Math.CThing_Position(_loc1_.vPosition.mX,Thing.Math.CThing_Position.mPFactor * _loc1_.vPosition.mY,- _loc1_.vPosition.mZ).ScaleN(1 / World.Map.CMap_Cell.mCellSize);
   }
   ...
   static function RenderStack_Process(timeStamp, timeAmount)
   {
      ...
      {
         _loc2_ = DrawPrimitive.XSI.CDrawPrimitive_XSI_DI.mRenderStack.pop();
         _loc1_ = _loc2_.renderInfo;
         DrawPrimitive.XSI.CDrawPrimitive_XSI_StyleSheet.SS_APPLY(_loc1_.mStyleSheet);
         _loc1_.asParent.Render(_loc1_.oFrame);
         _loc3_ = _loc1_.asParent.RenderToBitmap(_loc1_.oXSI_Animation);
   ...
   function Render(oFrame)
   {
      ...
      for(_loc29_ in _loc23_)
      {
         ...
         _loc16_ = _loc29_;
         _loc9_ = _loc9_ + 1;
         if(!this.mcPlanes[_loc9_])
         {
            this.mcPlanes[_loc9_] = this.mcGraphic.createEmptyMovieClip("_Plane" + _loc9_,10000 - _loc9_);
         }
         _loc2_ = this.mcPlanes[_loc9_];
         if(_loc5_.Empty)
         {
         ...
         if(this.mRenderFlags & this.mRenderFlag_ProfileEdge)
         {
            ...
            for(var _loc25_ in _loc14_)
            {
               ...
               while(_loc3_ < _loc7_)
               {
                  _loc2_.lineTo(_loc4_[_loc3_],_loc4_[_loc3_ + 1]);
                  _loc3_ += 2;
               }
            }
         ...
         _loc11_ = _loc5_.Shape_vList;
         _loc19_ = _loc5_.Shape_Matrix;
         _loc13_ = _loc5_.Shape_Material;
         _loc21_ = _loc5_.Shape_Brightness;
         ...
         if(this.mRenderFlags & this.mRenderFlag_Shadow)
         {
            ...
            for(_loc29_ in _loc12_)
            {
               ...
               while(_loc3_ < _loc7_)
               {
                  this.mcShadow.lineTo(_loc4_[_loc3_],_loc4_[_loc3_ + 1]);
                  _loc3_ += 2;
               }
