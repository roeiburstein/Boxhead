...
{
   var _Message_Failed;
   var _Message_Invalid;
   var _Message_Progress;
   var _Message_Success;
   var gameId;
   var ok;
   var playerName;
   var playerScore;
   static var mError;
   static var mSubmitted;
   static var mSubmitting;
      ...
      _loc2_.onLoad = function(ok)
      {
         if(ok)
         {
            ...
            switch(this.ok)
            {
               ...
               case 1:
                  External.CHighscore_Submit.mSubmitted = true;
                  this.getURL("http://scores.crazymonkeygames.com/hs/listscores.php?id=" + this.gameId,"_BLANK");
                  break;
               case 0:
               case "0":
   ...
   static function _GetKey(tString)
   {
      var _loc1_ = 0;
      var _loc2_ = "";
      while(_loc1_ < tString.length)
      {
         _loc2_ += random(Number(tString.charCodeAt(_loc1_) - 48)).toString();
         _loc1_ = _loc1_ + 1;
      }
      return _loc2_;
   }
