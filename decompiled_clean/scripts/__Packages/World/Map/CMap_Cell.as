class World.Map.CMap_Cell
{
   ...
   static var mDirectionM_E = ~(World.Map.CMap_Cell.mDirection_E | World.Map.CMap_Cell.mDirection_NE | World.Map.CMap_Cell.mDirection_SE);
   static var mDirectionM_SE = ~World.Map.CMap_Cell.mDirection_SE;
   static var mDirectionM_S = ~(World.Map.CMap_Cell.mDirection_S | World.Map.CMap_Cell.mDirection_SE | World.Map.CMap_Cell.mDirection_SW);
   static var mDirectionM_SW = ~World.Map.CMap_Cell.mDirection_SW;
   static var mDirectionM_W = ~(World.Map.CMap_Cell.mDirection_W | World.Map.CMap_Cell.mDirection_SW | World.Map.CMap_Cell.mDirection_NW);
   static var mDirectionM_NW = ~World.Map.CMap_Cell.mDirection_NW;
   static var mDirectionM_N = ~(World.Map.CMap_Cell.mDirection_N | World.Map.CMap_Cell.mDirection_NW | World.Map.CMap_Cell.mDirection_NE);
   static var mDirectionM_NE = ~World.Map.CMap_Cell.mDirection_NE;
   ...
   function ValidMoveDirection()
   {
      ...
      while(_loc2_ < 8)
      {
         if(this.mAdjacentCells[_loc2_] != undefined && (this.mAdjacentCells[_loc2_].mCollide & World.Map.CMap_Cell.mCollide_StaticImpassable) == 0)
         {
            return this.mAdjacentCells[_loc2_];
         }
         _loc2_ += 2;
      }
      return undefined;
   ...
   function LineIntersection(cLine)
   {
      ...
      for(var _loc9_ in this.mObjects)
      {
         ...
         if(_loc3_.mID != _loc2_.mID && _loc2_.mAffectFlags & _loc3_.cAffectFlags)
         {
            ...
            _loc4_ = cLine.QDistance_PointToLine_SQR(World.Map.CMap_Cell.xPOI);
   ...
   function LineIntersection_ThingList(cLine)
   {
      ...
      {
         _loc2_ = this.mObjects[_loc7_];
         if(_loc4_.mID != _loc2_.mID && _loc2_.mAffectFlags & _loc4_.cAffectFlags)
         {
            World.Map.CMap_Cell.xPOI.x = _loc2_.mPosition.mX;
            World.Map.CMap_Cell.xPOI.y = _loc2_.mPosition.mY;
            _loc3_ = cLine.QDistance_PointToLine_SQR(World.Map.CMap_Cell.xPOI);
   ...
   function LineIntersection_Map(cLine)
   {
      ...
      if((this.mCollide & World.Map.CMap_Cell.mCollide_Solid) == World.Map.CMap_Cell.mCollide_Solid)
      {
         ...
         {
            _loc6_ = cLine.mP1.y + (this.mP1.x - cLine.mP1.x) * _loc3_.xGradient;
         ...
         {
            _loc7_ = cLine.mP1.x + (this.mP1.y - cLine.mP1.y) * _loc3_.yGradient;
         ...
         if(_loc4_ != undefined || _loc5_ != undefined)
         {
            return {mCollideType:"wall",mPOI:(_loc4_ != undefined ? World.Map.CMap_Cell.xPOI : World.Map.CMap_Cell.yPOI)};
         }
      }
      return undefined;
   }
   function Nav_Direction(cDir, tDir, tCollideFlags, tForceIt)
   {
      ...
      if(World.Map.CMap_Cell.nSTimer - this.nID < 2000)
      {
         ...
         _loc4_ = this.ac.sortOn("nDist",Array.RETURNINDEXEDARRAY | Array.NUMERIC | Array.DESCENDING);
   ...
   {
      World.Map.CMap_Cell.nSTimer = getTimer();
      ...
      else if(World.Map.CMap_Cell.nState == "resume")
      {
         ...
         while(_loc3_ < 5 && World.Map.CMap_Cell.nList.length)
         {
            ...
            while(World.Map.CMap_Cell.pList.length)
            {
               ...
               if(getTimer() - World.Map.CMap_Cell.nSTimer > World.Map.CMap_Cell.nTimeOut)
               {
