class World.Map.CMap_Collide
{
   ...
   function PlayerCollide(tThing)
   {
      ...
      if(this.mCells[_loc5_.mY & 0xFFFF][_loc5_.mX & 0xFFFF].mCollide & World.Map.CMap_Cell.mCollide_StaticImpassable)
      {
         return _loc5_;
      }
      var _loc4_ = 3;
      ...
      while(_loc4_)
      {
         ...
         {
            _loc3_ = this.Collide_Mapwho(tThing.mPosition.Add(tThing.mDelta),tThing.mRadius,tThing.mID);
   ...
   {
      var _loc5_ = tThing.mPosition;
      if(this.mCells[_loc5_.mY & 0xFFFF][_loc5_.mX & 0xFFFF].mCollide & World.Map.CMap_Cell.mCollide_EdgeOfMap)
      {
         return _loc5_;
      }
      var _loc4_ = 1;
   ...
   function Collide_Map(main_p, main_d, main_r)
   {
      ...
      if(this.mCells[main_p.mY & 0xFFFF][main_p.mX & 0xFFFF].mCollide & World.Map.CMap_Cell.mCollide_EdgeOfMap)
      {
         return main_p;
      }
   ...
   function Collide_Mapwho(main_p, main_r, main_ID)
   {
      ...
      {
         _loc7_ = _loc8_[_loc11_].mObjects;
         for(_loc9_ in _loc7_)
         {
            ...
            if(_loc2_.mFlags & Thing.CThing.mFlag_Collidable && main_ID != _loc2_.mID)
            {
               if((_loc6_ = _loc2_.mPosition.Distance2D(main_p)) < main_r + _loc2_.mRadius)
               {
                  ...
                  _loc4_ = main_p.Subtract(_loc2_.mPosition);
   ...
   function Collide_Line(cThing, p1, p2, radius, cAffectFlags, cMapOnly)
   {
      ...
      var _loc5_ = _loc6_.mLength / World.Map.CMap_Collide._StepSize;
   ...
   function _Collide_Line_Area(rArea, cLine)
   {
      ...
      for(var _loc9_ in _loc4_)
      {
         ...
         {
            if((_loc5_ = scidd.Math.CMath.Distance_Sqr(_loc2_.mPOI,cLine.mP1)) < _loc3_)
            {
               _loc3_ = _loc5_;
               _loc7_ = _loc2_;
            }
