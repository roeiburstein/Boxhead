class World.Map.CMap_Mapwho
{
   ...
   function MoveThing(tThing)
   {
      ...
      var _loc5_ = tThing.mPosition.mX & 0xFFFFFF;
      var _loc4_ = tThing.mPosition.mY & 0xFFFFFF;
   ...
   {
      var _loc3_ = this.mMap_Cells[tThing.mPosition.mY & 0xFFFFFF][tThing.mPosition.mX & 0xFFFFFF];
