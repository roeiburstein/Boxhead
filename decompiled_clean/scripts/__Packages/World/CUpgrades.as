class World.CUpgrades extends MovieClip
{
   var Level;
   ...
   var mLevels;
   var mMultipleKills;
   var mMultipleKillsIndex;
   var mMultipleKillsTick;
   var mMultipleKillsTickTotal;
   var mMultiplierIndex;
   var mMultiplierTick;
   var mMultiplierTickTotal;
   var mMultipliers;
   var mTick;
   var mWorld;
   var v;
   var _CLASSID_ = "CUpgrades";
   var _BASECLASSID_ = "CUpgrades";
   function CUpgrades(tWorld)
   {
      super();
      this.mWorld = tWorld;
      this.mIDCount = 0;
   ...
   function SetDifficulty(tDifficulty)
   {
      var _loc3_ = 1;
      var _loc2_ = 1;
      if(World.CWorld.mGameMode == "DeathMatch")
   ...
   function AddUpgrade(tName, tClassID, tProp, tValue)
   {
      var _loc0_;
   ...
   function ApplyUpgrade_Creature_Player(tThing)
   {
   }
   function ApplyUpgrade_Creature_Devil(tThing)
   {
   ...
   function ApplyUpgrade_Creature_Zombie(tThing)
   {
      var _loc2_ = this[tThing._CLASSID_];
      if(_loc2_.IDCount == tThing.mUpgradeObject.mIDCount)
      {
   ...
   function ApplyUpgrade_Object(tThing)
   {
      var _loc2_ = this[tThing._CLASSID_];
      if(_loc2_.IDCount == tThing.mUpgradeObject.mIDCount)
      {
   ...
   function ApplyUpgrade_Weapon(tThing)
   {
   ...
   function Register_Creature_Zombie(tThing)
   {
      var _loc4_;
      var _loc0_;
      var _loc3_;
   ...
   function Register_Creature_Devil(tThing)
   {
      var _loc4_;
      var _loc0_;
      var _loc3_;
   ...
   function Register_Object(tThing)
   {
      var _loc4_;
      var _loc0_;
      var _loc3_;
   ...
   function Register_Weapon(tThing)
   {
      var _loc4_;
      var _loc0_;
      var _loc3_;
   ...
   function AddToMultipliers(tIndex, tObject)
   {
   ...
   function AddToMultipleKills(tIndex, tObject)
   {
   ...
   function AddToLevel(tIndex, tObject)
   {
   ...
   function get mMultiplier()
   {
      return this.mMultiplierIndex;
   }
   function get mMultiplierTickRatio()
   {
   ...
   function get mZombieCount()
   {
      return this.Level.mZombieCount;
   }
   function set mDevilCount(a)
   {
