class CSound
{
   var mcParent;
   var pClass;
   static var mAmbience;
   static var mAtmosphere;
   static var mCurrentAtmosphere;
   static var mProcessList;
   static var mSamples;
   static var mSound;
   static var mSoundList;
   ...
   static function Process(tItem)
   {
      ...
      {
         case "fadeout":
            _loc4_ = tItem.oSound.getVolume() - _loc2_ >= 0 ? tItem.oSound.getVolume() - _loc2_ : 0;
            ...
            break;
         case "fadein":
            _loc4_ = tItem.oSound.getVolume() + _loc3_ <= 100 ? tItem.oSound.getVolume() + _loc3_ : 100;
            tItem.pClass.SetVolume(tItem,_loc4_);
            if(_loc4_ == 100)
            {
               tItem.mAction = "none";
   ...
   static function Atmosphere_Start(tIndex)
   {
      ...
      CSound.mCurrentAtmosphere.mTimeStamp = getTimer();
      CSound.mCurrentAtmosphere.mChannels = new Array(2);
      var _loc1_ = 0;
      while(_loc1_ < CSound.mCurrentAtmosphere.mChannels.length)
      {
         CSound.mCurrentAtmosphere.mChannels[_loc1_] = new Object();
         CSound.mCurrentAtmosphere.mChannels[_loc1_].mCurrentSound = undefined;
         CSound.mCurrentAtmosphere.mChannels[_loc1_].mStartTS = undefined;
         CSound.mCurrentAtmosphere.mChannels[_loc1_].mStopTS = undefined;
         CSound.mCurrentAtmosphere.mChannels[_loc1_].mDelayTS = getTimer() + (random(10) + 10) * 1000;
         _loc1_ = _loc1_ + 1;
      }
   }
   static function Atmosphere_Stop()
   {
      ...
      while(_loc1_ < CSound.mCurrentAtmosphere.mChannels.length)
      {
         if(CSound.mCurrentAtmosphere.mChannels[_loc1_].mCurrentSound != undefined)
         {
            CSound.mCurrentAtmosphere.mChannels[_loc1_].mCurrentSound.mSound.StopSound();
            CSound.mCurrentAtmosphere.mChannels[_loc1_].mCurrentSound = undefined;
         }
         _loc1_ = _loc1_ + 1;
      }
   ...
   static function Atmosphere_Process()
   {
      ...
      var _loc2_ = 0;
      var _loc1_;
      while(_loc2_ < CSound.mCurrentAtmosphere.mChannels.length)
      {
         _loc1_ = CSound.mCurrentAtmosphere.mChannels[_loc2_];
         if(_loc1_.mCurrentSound == undefined)
         {
            if(_loc1_.mDelayTS != undefined)
            {
               if(getTimer() > _loc1_.mDelayTS)
               {
                  ...
                  _loc1_.mStartTS = getTimer();
                  _loc1_.mTimeOut = getTimer() + (5 + random(20)) * 1000;
               }
            }
         }
         else if(_loc1_.mCurrentSound.mSound.mPlaying == false)
         {
            ...
            _loc1_.mStopTS = getTimer();
            _loc1_.mDelayTS = getTimer() + random(15000);
         }
         else if(_loc1_.mTimeOut != undefined && getTimer() > _loc1_.mTimeOut)
         {
