class Thing.CThing_Collection
{
   ...
   function GetClosestPlayer(p)
   {
      ...
      {
         _loc2_ = this.mPlayerThings[_loc6_];
         if(!(_loc2_.mFlags & Thing.CThing.mFlag_DEAD))
         {
            if((_loc4_ = p.Distance2D_SQR(_loc2_.mPosition)) < _loc3_)
            {
               _loc3_ = _loc4_;
               _loc5_ = _loc2_;
            }
   ...
   function Process()
   {
      ...
      {
         _loc2_ = this.mPlayerThings[_loc5_].mPosition;
         _loc3_.push(_loc4_[_loc2_.mY & 0xFFFFFF][_loc2_.mX & 0xFFFFFF]);
      }
