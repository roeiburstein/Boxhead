class Thing.Creature.CThing_Creature_Zombie extends Thing.Creature.CThing_Creature
{
   ...
   var mTarget_Player;
   var mTarget_Position;
   var mThing_Collection;
   var mUniqueID;
   var mWorld;
   var mXSI_Animation;
   static var mXSI_Collection;
   ...
   function State_Attack()
   {
      ...
      {
         _loc3_ = this.mMap.mCells[this.mPosition.mY & 0xFFFFFF][this.mPosition.mX & 0xFFFFFF];
         _loc3_.mAdjacentCells[this.mAngle.mDirection].Affect(new Thing.Affect.CThing_Affect_ZombieAttack(this,this.mDamage));
         _loc2_ = this.mReturnStateID;
