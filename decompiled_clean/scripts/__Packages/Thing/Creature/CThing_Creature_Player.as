class Thing.Creature.CThing_Creature_Player extends Thing.Creature.CThing_Creature
{
   ...
   function Process_Init()
   {
      ...
      var _loc4_;
      if(this.mWorld.mUpgrades.mTotalPlayerCount == 1)
      {
         CMain.mInput.AddAdditionKeyCode(this.mControls.FIRE,CInput.ToAscii(" "));
         _loc4_ = 0;
         while(_loc4_ < 10)
         {
            this.mControls["SELECT" + _loc4_] = CMain.mInput["KEY_SELECT" + _loc4_ + this.mControl_PostFix];
            _loc4_ = _loc4_ + 1;
         }
      }
   ...
   function State_PlayerControl()
   {
      ...
      {
         this.mAngle.mDelta = this.mDelta;
      }
      var _loc4_;
   ...
   function KeepDistance()
   {
      ...
      {
         _loc2_ = this.mThing_Collection.GetOtherPlayer(this);
         if(!_loc2_ || _loc2_.mFlags & Thing.CThing.mFlag_DEAD)
         {
            return this;
         }
         _loc6_ = Math.abs(_loc2_.mPosition.mX - this.mPosition.mX);
         _loc4_ = Math.abs(_loc2_.mPosition.mX - (this.mPosition.mX + this.mDelta.mX));
         _loc5_ = Math.abs(_loc2_.mPosition.mY - this.mPosition.mY);
         _loc3_ = Math.abs(_loc2_.mPosition.mY - (this.mPosition.mY + this.mDelta.mY));
         if(_loc4_ > _loc6_)
         {
            if(_loc4_ > 19)
            {
   ...
   function State_Respawn()
   {
      ...
      if(--this.mStateCount < 0)
      {
         _loc2_ = this.mWorld.Spawn_Player_PositionObject(this.mThing_Collection.GetOtherPlayer(this));
         if(_loc2_)
         {
            this.mAlpha = 100;
            ...
            this.mAngle.mAngle = _loc2_.mAngle.mAngle;
            ...
            ++this.mWorld.mUpgrades.mPlayerCount;
         }
      }
   }
   function InitWeapons()
   {
      ...
      {
         this.mWeapons[_loc3_[_loc2_]] = {mIndex:_loc2_,mNameID:_loc3_[_loc2_],mClassID:_loc4_[_loc2_],mThing:undefined,mActive:false,mKeyID:(_loc2_ + 1) % 10};
         this.mWeaponList[_loc2_] = this.mWeapons[_loc3_[_loc2_]];
         _loc2_ = _loc2_ + 1;
      }
   ...
   function SelectWeapon(tWeaponName)
   {
      ...
      {
         _loc3_ = this.mWeapon_Current.mNameID;
   ...
   function RandomPickup()
   {
      ...
      for(var _loc7_ in this.mWeapons)
      {
         ...
         {
            _loc4_ = this.mWeapons[_loc7_];
            _loc8_ = (1 - _loc4_.mThing.mAmmo / _loc4_.mThing.mTotalAmmo) * 0.75 + 0.25;
            _loc5_ += _loc8_;
      ...
      {
         if(_loc6_ < _loc3_[_loc2_].mChanceIndex)
         {
            if(_loc3_[_loc2_].mNameID == "life")
            {
            ...
            {
               this.mWorld.mHud.AddMessage_Info("Picked up " + this.AddWeapon(_loc3_[_loc2_].mNameID).mThing.mName,this.mPlayerIndex);
            }
            return true;
         }
         _loc2_ = _loc2_ + 1;
   ...
   function NextWeapon()
   {
      ...
      while(_loc3_ < _loc4_)
      {
         _loc2_ = (_loc5_.mIndex + _loc3_) % _loc4_;
   ...
   function PrevWeapon()
   {
      ...
      while(_loc4_ < _loc3_)
      {
         _loc2_ = (_loc5_.mIndex + _loc3_ - _loc4_) % _loc3_;
         if(this.mWeaponList[_loc2_].mActive && !this.mWeaponList[_loc2_].mThing.WeaponEmpty())
         {
            return this.mWeaponList[_loc2_];
         }
   ...
   function GetWeaponPosition()
   {
      ...
      var _loc2_ = this.mXSI_Animation.XSI_Info.XSI_Model_GunPosition_Right.nPosition;
