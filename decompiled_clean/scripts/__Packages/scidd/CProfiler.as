class scidd.CProfiler
{
   ...
   static function Clear()
   {
      ...
      {
         _loc1_ = scidd.CProfiler.obj.mList[_loc2_];
         _loc1_.mTotalTime = 0;
   ...
   static function Timer_Stop(tID)
   {
      ...
      var _loc1_ = scidd.CProfiler.obj.Find(tID);
      _loc1_.mEndTime = getTimer() - _loc1_.mStartTime;
