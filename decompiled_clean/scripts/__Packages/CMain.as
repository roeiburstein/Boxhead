class CMain extends MovieClip
{
   var _Size;
   var fState;
   var mReturn_SelectWorld;
   var mScreenSize;
   var mScreen_Collection;
   var mStateCount;
   var mTimeSlice;
   var mWorldLibLink;
   var mcScreen;
   ...
   var onEnterFrame;
   static var _this;
   static var mInitBGTimeStamp;
   static var mInput;
   static var mProfiler;
   static var mSaveData;
   static var mSound;
   var _CLASSID_ = "CMain";
   ...
   static function ProcessBGTasks()
   {
      ...
      {
         CMain.mInitBGTimeStamp = getTimer();
         _loc3_ = new DrawPrimitive.XSI.CDrawPrimitive_XSI_DI(_global.mXSI_Data.mItems);
      ...
      DrawPrimitive.XSI.CDrawPrimitive_XSI_DI.RenderStack_Process(CMain.mInitBGTimeStamp,_loc2_);
      CMain.mInitBGTimeStamp = getTimer();
   }
   static function AddPlayers()
   {
   }
   function Draw()
   {
   ...
   function ProcessFrames(tFrameRate)
   {
      ...
      var _loc2_ = Math.floor((getTimer() - this.mTimeSlice) / _loc3_);
      if(_loc2_ > 0)
      {
   ...
   {
      CMain._this.mTimeSlice = getTimer();
   }
}
