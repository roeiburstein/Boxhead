class CInput
{
   ...
   var mDown;
   var mKey_List;
   var mKey_List_Registered;
   var mKeycode;
   var mKeycode_1;
   var mPressed;
   var mReleased;
   var pClass;
   static var mValidKeys;
   ...
   function CInput()
   {
      ...
      this.ResetKeys();
      this.RegisterKey("KEY_UP",CMain.mSaveData.mPlayer1_KeyMoveUp);
      this.RegisterKey("KEY_DOWN",CMain.mSaveData.mPlayer1_KeyMoveDown);
      this.RegisterKey("KEY_LEFT",CMain.mSaveData.mPlayer1_KeyMoveLeft);
      this.RegisterKey("KEY_RIGHT",CMain.mSaveData.mPlayer1_KeyMoveRight);
      this.RegisterKey("KEY_FIRE",CMain.mSaveData.mPlayer1_KeyShoot);
      this.RegisterKey("KEY_NEXT_WEAPON",CMain.mSaveData.mPlayer1_KeyNextWeapon);
      this.RegisterKey("KEY_PREV_WEAPON",CMain.mSaveData.mPlayer1_KeyPrevWeapon);
      this.RegisterKey("KEY_UP2",CMain.mSaveData.mPlayer2_KeyMoveUp);
      this.RegisterKey("KEY_DOWN2",CMain.mSaveData.mPlayer2_KeyMoveDown);
      this.RegisterKey("KEY_LEFT2",CMain.mSaveData.mPlayer2_KeyMoveLeft);
      this.RegisterKey("KEY_RIGHT2",CMain.mSaveData.mPlayer2_KeyMoveRight);
      this.RegisterKey("KEY_FIRE2",CMain.mSaveData.mPlayer2_KeyShoot);
      this.RegisterKey("KEY_NEXT_WEAPON2",CMain.mSaveData.mPlayer2_KeyNextWeapon);
      this.RegisterKey("KEY_PREV_WEAPON2",CMain.mSaveData.mPlayer2_KeyPrevWeapon);
   ...
   function ResetKeys()
   {
      ...
      while(_loc2_ < 256)
      {
         this.mKey_List[_loc2_] = {mKeycode:_loc2_,mPressed:false,mTimePressed:0,mDown:false,mReleased:false,mTimeDown:0,mTimeReleased:0};
         this.mKey_List[_loc2_].IsPressed = function()
         {
            if(this.mPressed)
            {
               this.mPressed = false;
         ...
         this.mKey_List[_loc2_].IsReleased = function()
         {
            if(this.mReleased)
            {
         ...
         this.mKey_List[_loc2_].IsDown = function()
         {
            return Key.isDown(this.mKeycode) || Key.isDown(this.mKeycode_1);
         };
         this.mKey_List[_loc2_].IsUp = function()
         {
            return !this.IsDown();
         };
         this.mKey_List[_loc2_].Renew = function()
         {
            this.mReleased = false;
            this.mPressed = false;
            this.mDown = false;
   ...
   function AnyKeyPressed()
   {
      ...
      while(_loc2_ < 256)
      {
         if(this.mKey_List[_loc2_].mPressed)
         {
            return true;
         }
         _loc2_ = _loc2_ + 1;
   ...
   function UpdateKey(tKey)
   {
      if(tKey.IsDown())
      {
         ...
         {
            tKey.mDown = true;
            tKey.mTimeDown = getTimer();
            if(!tKey.mPressed)
            {
               tKey.mPressed = true;
               tKey.mTimePressed = getTimer();
            }
         }
      }
      else if(tKey.mDown)
