...
export const UPGRADE_LADDER: readonly UpgradeMilestone[] = [
  { multiplier: 3, type: 'upgrade', weaponId: 'pistol', name: 'Pistol+: Fast Fire', description: 'Cooldown 0.32s -> 0.16s', effectType: 'fast_fire' },
  { multiplier: 5, type: 'unlock', weaponId: 'uzi', name: 'New Weapon: UZI (Key 2)', description: 'Unlocks automatic UZI (100 ammo)', effectType: 'unlock' },
  { multiplier: 8, type: 'upgrade', weaponId: 'pistol', name: 'Pistol+: Double Damage', description: 'Damage 26 -> 52', effectType: 'double_damage' },
  { multiplier: 10, type: 'unlock', weaponId: 'shotgun', name: 'New Weapon: Shotgun (Key 3)', description: 'Unlocks 3-pellet shotgun (20 ammo)', effectType: 'unlock' },
  { multiplier: 13, type: 'upgrade', weaponId: 'uzi', name: 'UZI+: Rapid Fire', description: 'Cooldown 0.16s -> 0.08s', effectType: 'rapid_fire' },
  ...
  { multiplier: 17, type: 'upgrade', weaponId: 'uzi', name: 'UZI+: Double Ammo', description: 'Max ammo 100 -> 200, +100 ammo granted', effectType: 'double_ammo' },
  { multiplier: 18, type: 'upgrade', weaponId: 'shotgun', name: 'Shotgun+: Fast Fire', description: 'Cooldown 0.48s -> 0.32s', effectType: 'fast_fire' },
  { multiplier: 20, type: 'unlock', weaponId: 'grenade', name: 'New Weapon: Grenade (Key 5)', description: 'Unlocks hand grenades (20 count)', effectType: 'unlock' },
  { multiplier: 21, type: 'upgrade', weaponId: 'shotgun', name: 'Shotgun+: Double Ammo', description: 'Max ammo 20 -> 40, +20 ammo granted', effectType: 'double_ammo' },
  ...
  { multiplier: 30, type: 'unlock', weaponId: 'fakewall', name: 'New Weapon: Fake walls (Key 6)', description: 'Unlocks placeable barricades (5 count)', effectType: 'unlock' },
  { multiplier: 31, type: 'upgrade', weaponId: 'shotgun', name: 'Shotgun+: Wide Shot', description: 'Pellets 3 -> 5, spread cone ±1.25 -> ±2.5 deg', effectType: 'wide_shot' },
  { multiplier: 32, type: 'upgrade', weaponId: 'barrel', name: 'Barrel+: Big Bang', description: 'Radius 4.5 -> 6.0, damage 150 -> 200', effectType: 'big_bang' },
  ...
  { multiplier: 37, type: 'upgrade', weaponId: 'fakewall', name: 'Fake Wall+: Double Ammo', description: 'Max ammo 5 -> 10, +5 walls granted, HP 1000 -> 1500', effectType: 'double_ammo' },
  { multiplier: 39, type: 'upgrade', weaponId: 'uzi', name: 'UZI+: Quad Ammo', description: 'Max ammo 200 -> 400, +200 ammo granted', effectType: 'quad_ammo' },
  ...
  { multiplier: 41, type: 'upgrade', weaponId: 'shotgun', name: 'Shotgun+: Quad Ammo', description: 'Max ammo 40 -> 80, +40 ammo granted', effectType: 'quad_ammo' },
  { multiplier: 42, type: 'upgrade', weaponId: 'grenade', name: 'Grenade+: Double Ammo', description: 'Max ammo 20 -> 40, +20 grenades granted', effectType: 'double_ammo' },
  { multiplier: 43, type: 'upgrade', weaponId: 'shotgun', name: 'Shotgun+: Rapid Fire', description: 'Cooldown 0.32s -> 0.20s', effectType: 'rapid_fire' },
  { multiplier: 44, type: 'upgrade', weaponId: 'barrel', name: 'Barrel+: Bigger Bang', description: 'Radius 6.0 -> 8.0, damage 200 -> 300', effectType: 'bigger_bang' },
  { multiplier: 45, type: 'upgrade', weaponId: 'grenade', name: 'Grenade+: Big Bang', description: 'Radius 4.5 -> 6.0, damage 150 -> 200', effectType: 'big_bang' },
  ...
  { multiplier: 48, type: 'upgrade', weaponId: 'uzi', name: 'UZI+: Double Damage', description: 'Bullet damage 35 -> 70', effectType: 'double_damage' },
  ...
  { multiplier: 51, type: 'upgrade', weaponId: 'shotgun', name: 'Shotgun+: Wider Shot', description: 'Pellets 5 -> 7, spread cone ±2.5 -> ±4.0 deg', effectType: 'wider_shot' },
  { multiplier: 52, type: 'upgrade', weaponId: 'grenade', name: 'Grenade+: Quad Ammo', description: 'Max ammo 40 -> 80, +40 grenades granted', effectType: 'quad_ammo' },
  { multiplier: 53, type: 'upgrade', weaponId: 'fakewall', name: 'Fake Wall+: Quad Ammo', description: 'Max ammo 10 -> 20, +10 walls granted, HP 1500 -> 2000', effectType: 'quad_ammo' },
  ...
  { multiplier: 55, type: 'unlock', weaponId: 'chargepack', name: 'New Weapon: Chargepack (Key 9)', description: 'Unlocks remote-detonated C-4 satchels (10 count)', effectType: 'unlock' },
  { multiplier: 56, type: 'upgrade', weaponId: 'shotgun', name: 'Shotgun+: Double Damage', description: 'Pellet damage 51 -> 102', effectType: 'double_damage' },
  { multiplier: 57, type: 'upgrade', weaponId: 'grenade', name: 'Grenade+: Bigger Bang', description: 'Radius 6.0 -> 8.0, damage 200 -> 300', effectType: 'bigger_bang' },
  { multiplier: 58, type: 'upgrade', weaponId: 'claymore', name: 'Claymore+: Big Bang', description: 'Radius 4.0 -> 5.5, damage 100 -> 150', effectType: 'big_bang' },
  { multiplier: 59, type: 'upgrade', weaponId: 'rocket', name: 'Rocket+: Fast Fire', description: 'Cooldown 0.48s -> 0.32s', effectType: 'fast_fire' },
  ...
  { multiplier: 62, type: 'upgrade', weaponId: 'claymore', name: 'Claymore+: Bigger Bang', description: 'Radius 5.5 -> 7.0, damage 150 -> 200', effectType: 'bigger_bang' },
  ...
  { multiplier: 68, type: 'upgrade', weaponId: 'chargepack', name: 'Charge Pack+: Double Ammo', description: 'Max ammo 10 -> 20, +10 charges granted', effectType: 'double_ammo' },
  { multiplier: 70, type: 'unlock', weaponId: 'railgun', name: 'New Weapon: Railgun (Key 0)', description: 'Unlocks instant laser beam sniper (15 charges)', effectType: 'unlock' },
  { multiplier: 72, type: 'upgrade', weaponId: 'rocket', name: 'Rocket+: Big Bang', description: 'Radius 4.0 -> 5.5, damage 250 -> 350', effectType: 'big_bang' },
  { multiplier: 74, type: 'upgrade', weaponId: 'chargepack', name: 'Charge Pack+: Big Bang', description: 'Radius 5.0 -> 7.0, damage 150 -> 225', effectType: 'big_bang' },
  { multiplier: 76, type: 'upgrade', weaponId: 'chargepack', name: 'Charge Pack+: Quad Ammo', description: 'Max ammo 20 -> 40, +20 charges granted', effectType: 'quad_ammo' },
  { multiplier: 78, type: 'upgrade', weaponId: 'railgun', name: 'Railgun+: Fast Fire', description: 'Cooldown 0.20s -> 0.12s', effectType: 'fast_fire' },
  { multiplier: 80, type: 'upgrade', weaponId: 'railgun', name: 'Railgun+: Double Ammo', description: 'Max ammo 15 -> 30, +15 charges granted', effectType: 'double_ammo' },
  ...
  { multiplier: 90, type: 'upgrade', weaponId: 'uzi', name: 'UZI+: Quad Damage', description: 'Bullet damage 70 -> 140', effectType: 'quad_damage' },
  { multiplier: 95, type: 'upgrade', weaponId: 'chargepack', name: 'Charge Pack+: Bigger Bang', description: 'Radius 7.0 -> 9.0, damage 225 -> 300', effectType: 'bigger_bang' },
  { multiplier: 100, type: 'upgrade', weaponId: 'railgun', name: 'Railgun+: Rapid Fire', description: 'Cooldown 0.12s -> 0.08s', effectType: 'rapid_fire' },
  { multiplier: 105, type: 'upgrade', weaponId: 'rocket', name: 'Rocket+: Bigger Bang', description: 'Radius 5.5 -> 7.0, damage 350 -> 500', effectType: 'bigger_bang' },
  { multiplier: 110, type: 'upgrade', weaponId: 'railgun', name: 'Railgun+: Quad Ammo', description: 'Max ammo 30 -> 60, +30 charges granted', effectType: 'quad_ammo' },
